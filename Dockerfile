...
ENV PATH="$PWD/gcc-linaro-7.5.0-2019.12-i686_aarch64-linux-gnu/bin/:$PATH"
...
RUN apt-get update && \
    ...
    wget -c https://releases.linaro.org/components/toolchain/binaries/latest-7/aarch64-linux-gnu/gcc-linaro-7.5.0-2019.12-i686_aarch64-linux-gnu.tar.xz && tar xf gcc-linaro-7.5.0-2019.12-i686_aarch64-linux-gnu.tar.xz && \

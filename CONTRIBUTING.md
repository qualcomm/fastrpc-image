...
1. [Fork](https://github.com/qualcomm/fastrpc-image/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/fastrpc-image.git
    ``` 
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/fastrpc-image.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/fastrpc-image/pulls) from your branch to `main`.
